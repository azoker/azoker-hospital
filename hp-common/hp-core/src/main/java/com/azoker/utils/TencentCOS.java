...
/**
 * Created by zxd on 2022/2/28
 **/
public class TencentCOS {

    //此处填写的存储桶名称
    private static final String bucketName = "ten24629567";

    //secretId
    private static final String secretId = "AKIDCVnGh7a7koyCXvW";

    //secretKey
    private static final String secretKey = "mcTNLUrWfovxwskV";
